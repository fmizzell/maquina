...
// @codingStandardsIgnoreEnd
{
    ...
    public function testSqlString()
    {
        ...
        $valid_sql_strings[] = '[SELECT * FROM abc][ORDER BY qrs];';
        $valid_sql_strings[] = '[SELECT * FROM abc][ORDER BY qrs, tuv];';
        $valid_sql_strings[] = '[SELECT * FROM abc][ORDER BY qrs, tuv][LIMIT 1];';
        $valid_sql_strings[] = '[SELECT * FROM abc][ORDER BY qrs, tuv][LIMIT 1 OFFSET 2];';
        $valid_sql_strings[] = '[SELECT * FROM abc][LIMIT 1];';
        $valid_sql_strings[] = '[SELECT * FROM abc][LIMIT 1 OFFSET 2];';
    ...
    private function getSqlMachine()
    {
        ...
        $machine->addTransition('select_end', ["["], "order_by");
        ...
        $machine->addTransition('select_end', ["["], "limit");
